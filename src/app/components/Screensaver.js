...
const Screensaver = ({ idleTimeout = 5000, quoteInterval = 5000 }) => {
      ...
      {isIdle && (
        <div className="fixed inset-0 bg-black z-50 flex items-center justify-center">
          ...
          <video
            ...
            playsInline
          />
          <div className="absolute bottom-5 z-20 h-[40vh] flex flex-col items-start justify-center px-10 pb-6 bg-transparent text-white">
